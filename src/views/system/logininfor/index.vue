<template>
  <div class="app-container">
    ...
    <el-table border size='mini' align="center" stripe ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
