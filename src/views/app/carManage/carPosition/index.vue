...
<!--      </el-form-item>-->
    ...
    <el-table class="table-grid-box"
      ...
      <el-table-column label="操作"
        ...
        <template slot-scope="scope">
          <el-button size="mini"
                     type="text"
                     @click="carPosition(scope.row)"
                     v-hasPermi="['system:car:edit']">车辆位置</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <!--实时位置弹框-->
    <carPositionDialog v-if="showCarPosition" :showCarPosition.sync="showCarPosition" :vin.sync="vin" :vehicleNum="vehicleNum"/>
  </div>
</template>
...
import carPositionDialog from '@/views/app/carManage/carPosition/carPositionDialog'
...
export default {
  ...
  methods: {
    ...
    carPosition(row){
      ...
      this.showCarPosition = !this.showCarPosition;
    },
  },
}
</script>
